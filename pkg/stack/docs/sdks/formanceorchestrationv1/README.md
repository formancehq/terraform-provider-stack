...
<!-- UsageSnippet language="go" operationID="flowsgetServerInfo" method="get" path="/api/orchestration/_info" -->
```go
package main
...
func main() {
    ...
    res, err := s.Orchestration.V1.FlowsgetServerInfo(ctx)
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.FlowsgetServerInfoResponse](../../pkg/models/operations/flowsgetserverinforesponse.md), error**
